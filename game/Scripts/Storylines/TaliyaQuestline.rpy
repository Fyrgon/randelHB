...
label TaliyaQ0:
    ...
    if fakeName.strip().lower() in ("taliya", "taliyah", "talia", "yami"):
        "Boss" "What?!"
    ...
    mc "Ahh...."
    pause 6
    mc "{i}Think... Think...{p}Shit, the only thing I can think about is how good this feels!"
    pause 3
    ...
    t "Mh, go ask the inn keeper. If you don't have enough gold I'll lend you some."
    mc "Thanks."
    scene generictavern
    ...
    mc "{i}...Worth it."
    $ renpy.notify("{color=#fff}You gained 25 gold")
    $ money += 50
    pause 1
...
label TaliyaQ2:
    ...
    menu:
        "Apologize":
            jump keepgoingtq2
        "Say goodbye" if easyMode == False:
            mc "{i}Nah, it's alright, she seems to have forgiven me."
            t "Well, goodbye, recruit."
            mc "Oh, uh, bye general."
            "Taliya leaves, she looks kind of disappointed. You shrug it off and walk away."
            $ TaliyaQ = -1
            jump market
    label keepgoingtq2:
...
label TaliyaQ3:
    ...
    "Man" "Ugh, you're worthless. Wasted gold on you for nothing. Leave."
...
label TaliyaQ4:
    ...
    if money < 1:
        ...
        mc "Thank Astylla I've brought along [money] coins then."
    if money >= 100:
    ...
    t "Getting saved."
    mc "Probably."
    t "I don't remember the last time I needed to be saved... On Astylla, my body feels so weak..."
    ...
    hide taliyagrind0 with dissolve
...
label TaliyaQ5:
    ...
    play music market
    if dayTQ5 >= day:
        "You arrive at the market in the early morning. You know that you couldn't go on the day you should've, but you still thought of going as if it meant anything."
        mc "{i}Ah... I missed the day- Wait what is Taliya doing here?"
        mc "Taliya?"
        t "Oh, goodmorning, [mc]."
        mc "What are you doing here?"
        t "The King took more than I anticipated to reply to my missive. We're departing today."
        mc "Oh. That's... awfully convenient."
        t "You didn't know?"
        mc "Uh, I, uhm..."
        t "I thought you hadn't showed up because someone had told you... Guess I was wrong."
        mc "Sorry... But, hey, I'm here now, general."
        t "Good enough."
        t "...You don't have to call me general, you know, right?"
        mc "Why not?"
        t "You're here as a friend, not as a subordinate. You can call me Taliya."
        mc "Are you really sure? I feel like we're gonna get some awkward stares..."
        t "They won't. They're my men and they respect me enough not to do that."
        mc "If you say so."
    else:
...
label TaliyaQ6:
    ...
    menu:
        "Try to walk away":
            ...
            menu:
                "Walk Away" if easyMode == False:
                    ...
                    mc "{i}What the hell got into her? Could these be the lasting effects of the drug? Fuck, I hope not."
            ...
            t "You came so much~"
            mc "Yeah..."
            mc "{i}She made me cum so easily... Fuck she's hot."
        ...
        "Top her":
            ...
            pause 1
            scene taliyawax4 with vpunch
            t "S-Shit- I knew this w-was a good idea! Ah~!"
