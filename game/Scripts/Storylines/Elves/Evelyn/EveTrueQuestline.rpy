...
label fightgoblin:
    ...
    e "Sander, if I catch you peeking again, I swear on Astylla I'll rip you in half!"
    show suprised
    hide smirks
    show talksr
...
label campq:
    ...
    $ renpy.notify("{color=#fff}You gained 100 gold")
    $ money += 100
    mc "Thanks!"
    scene agblr
    show smilee
...
label EveQ1:
    ...
    menu:
        "Grab her hand" if easyMode == False:
            mc "Hold on!"
    ...
    e "Huh?"
    mc "{i}Oh Astylla, don't tell me she forgot everything!"
...
label EveQ4:
        ...
        menu:
            "Pull down her towel":
                ...
                mc "What kind of things did you mean?"
                e "I-I-I..."
