label gabeBeginning:
        ...
        hide suprised
        g "Yeah, I know, it's a pain in the ass. But it seems the new passed a new law and now we have to do even more tests and if you fail even just one you're out."
        show talkwamc
        hide talkwanmc
        ...
        g "Adventurers are the only ones who constantly deal with threats to sustain themselves. A soldier might get deployed in the west, never see ad emon in their life, rank up enough to never see the frontline again and retire at 40."
        ...
        g "Sure, Gold-Rank adventurers get a lot of money but you know how long and how dangerous it is to get there? I don't mean no offense but it's a slim chance and I don't want to see you take it."
        menu:
...
hide talkt
hide talksgop
hide normalt with easeoutright
show cuteg
g "...Yes, ma'am."
play music forest
