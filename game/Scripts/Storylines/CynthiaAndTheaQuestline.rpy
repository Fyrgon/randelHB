label thcynth1:
    ...
    c "Oh hey, [mc]."
    mc "H-Hey..."
    mc "{i}Oh Astylla... This was a bad idea."
    hide theshy
    show normalcb
    mc "...What are you girls talking about?"
    show theshy
    th "Nothing!"
    mc "{i}Thea looks off."
    show blushtalkac
    ...
    "Cynthia grabs Thea by her hand and drags her up to the Guild Quarters."
...
label thcynth2:
    ...
    j "The two of them have been spending a lot of time together recently."
    mc "Are they in the Guild Quarters?"
    j "Yes. Is something the matter, [mc]?"
    mc "Oh, no... No. It's nothing."
    j "Oh, okay."
    scene adventurersguild_evening
    mc "{i}The two of them are definitely planning something."
    mc "{i}I should try to figure out what's going on with those two."
    ...
    c "This is a punishment, after all."
    mc "{i}\"P-Punishment?\""
    ...
    th "It sounds... Fun."
    mc "{i}Oh Astylla!"
    c "Oh-ho! And here I thought you were a pure angel... Very interesting~"
    th "Hehe..."
    ...
    mc "Aah!"
    c "Huh?"
    c "{size=-3}...I think someone's at the door."
    mc "{size=-1}-Sander!"
    sa "I'm sorry."
    mc "Come! We gotta go."
    ...
    menu:
        "Tell Sander.":
            ...
            sa "The two of them have probably forgiven you already. You came clean, that rarely happens."
            mc "You think so...?"
            sa "Yeah."
            ...
            if evesex >= 1:
                ...
                sa "Hmm..."
                sa "It's not my business. Eve is in a very good mood nowadays, so no complaints there."
                mc "Really?"
                ...
                sa "Hahaha."
            sa "Okay kid, that's all the time I have for today."
            sa "If you're sure your harem's trying to kill you, don't worry, I'll be your back-up."
            mc "Ok... Yeah, thanks."
            $ thcynthconfess += 1
            jump guild
        "Don't tell Sander":
            ...
            sa "Really?"
            mc "Yeah."
            sa "Bummer. Well, you haven't still mastered the art of voyeurism, so you're eavesdropping skills might be too low."
            mc "Hmm... I guess so."
            ...
            mc "{i}Shit, shit, shit!"
            mc "{i}Those two are definitely going to kill me!."
            $ thcynthconfess += 1
            jump guild
...
label thcynth3:
    ...
    c "Hey, hey keep it down. We don't want to excite the neighbours."
    ...
    menu:
        ...
        "Just accept it":
            mc "{i}This is all my fault. I'm just getting what was coming for me."
    ...
    c "Hah, sure."
    "Cynthia brings a crate of bottles and keeps it in front of you."
    mc "Wait, is that."
    c "Oh yes, a crate full of my elixir. I think there's about 30 of them here."
    ...
    mc "T-Thea! You didn't actually agree to this did you? Please just tell Cynthia to-"
    c "It was her idea actually."
    mc "WHAT!?"
    th "I-It was either this or Cynthia's plan."
    mc "...Which was?"
    th "To... uhm... How should i say this-"
    c "Take turns fucking {b}your{/b} ass."
    mc "..."
    ...
    mc "Do what you must."
    mc "{i}I'm such an asshole. Why did I feel like this was ok?"
    ...
    "The two of them take turns fucking you. Just when you think it's over, Cynthia pops open another bottle and forces it down your throat. The slight pleasure you felt at the beginning is no more as you can now barely feel anything between your legs."
    ...
    th "Sorry."
    c "Hey, we aren't supposed to feel sorry."
    th "Oh, yeah, true."
    ...
    mc "What...?"
    mc "Whatever, it's not like I'm in any position to question anything."
    c "Yes, exactly."
    mc "......"
    mc "But... I still..."
    mc "I'm really sorry."
    ...
    "{color=#FF893A}Thea & {/color}{color=#FF7F7F}Cynthia" "Zzz..."
    "You head downstairs."
