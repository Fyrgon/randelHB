...
label monsterindex:
            ...
            if bom == "":
                mc "Ugh... I forgot..."
                jump library
            $bare = bom.lower().strip()
            if bare in ["boar", "boars"]:
            ...
            if bare in ["alpha falcon", "alpha falcons"]:
            ...
            if bare in ["wallcrawler", "wallcrawlers"]:
            ...
            if bare in ["blood butterfly", "blood butterflies"]:
