label nessatalk:
    ...
    menu:
        ...
        "Ask about Zenelith's house" if bothpath == 2:
            ...
            mc "Oh no, no! My dick can't take anymore!"
        ...
        "About Aerin" if aerinQ >= 1:
            ...
            n "The duel? Well, it's a close call, but I'd put my gold on Eve. She's got more experience in fighting real enemies, you know? Aerin has trained a lot but, she hasn't put it to much use."
