label meganTalk:
    ...
    if metmegangq == 0:
        ...
        m "So I graduated from the Academy. Then I left town, got to Randel and joined the Guild. That's when I thought not to stand out. If I did, everyone would hate me again."
