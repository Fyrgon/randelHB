label wotv1:
    ...
    hide talksadhappymc
    show talkwas
    sa "Whaaaaaaa... really? I don't seem to remember... Oh shit, are you that kid I owe 200 gold?"
    show talkwanmc
    hide talkwas
    mc "What? No! Wait... you owe a kid 200 gold?"
    hide talkwanmc
    show talkns
    sa "None of your business, kid..."
    sa "...Thank Astylla, it's not him..."
    hide talkns
    show talkwanmc
...
label wotv3:
    ...
    if magiclvl > 0:
        ...
        mc "{i}Oh Astylla... I'm about to see my childhood friend naked in front of me."
        ...
        menu:
            "Wow, Gabe...":
                mc "{i}It's really been 6 years... Her body has really grown a lot."
...
label wotv4:
    ...
    menu:
        ...
        "Yeah, I did":
            ...
            sa "Here, take it."
            mc "What?"
            sa "Take it. It's 30 gold."
            menu:
                "Thanks":
                    show talksadhappymc
                    mc "Thanks."
                    $ money += 30
                    $ renpy.notify("{color=#fff}You gained 30 gold.")
