default mineQuest = False
default hadNadiaBlowYou = False
...
label endhunt:
    ...
    "{color=#fff}Dwarf" "I found this while I was mining one day. It's valuable. You can sell it for at least 200 gold."
    mc "{i}200 gold?! Wow, that's a lot... Dwarves are known to be generous. I guess that's true then."
    menu:
        "Take the diamond":
            show talkhappymc
            $ diamond += 1
        ...
        "I was thinking of something else...":
            $ hadNadiaBlowYou = True
            mc "{i}He's in the mood to offer anything. I should take this chance."
            mc "I was thinking of something other than gold."
            ...
            menu:
                "Say thank you":
                    ...
                    Nadia "Oh, you are such a cutie~ Bye-bye!"
                "Just leave":
    ...
    pause 1
    $ renpy.notify ("{color=#fff}You gained 40 gold.")
    $ money += 40
    $ mineQuest = True
    jump guild
